...
wind.add_lonlat().vertical_level(300 * 100)
wind.time(now)
...
hght.add_lonlat().vertical_level(300 * 100)
hght.time(now)
...
plt.title("300MB ANALYSIS",loc='left',fontsize=8,fontweight='bold',
          y=-0.07)
...
# Plot!
plt.savefig('./images/300MB.png', dpi=300, bbox_inches='tight')
